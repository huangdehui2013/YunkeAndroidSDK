 ...
 * description：
 */
public class YunKeViewPager extends ViewPager {
    ...
    public YunKeViewPager(Context context) {
    ...
    public YunKeViewPager(Context context, AttributeSet attrs) {
    ...
    public void setPageChangeDuration(int duration) {
        ...
        try {
            ...
            scrollerField.set(this, new YunKeBannerScroller(getContext(), duration));
