 ...
 * description：
 */
public class YunKeBannerUtil {
    private YunKeBannerUtil() {
    ...
    public static ImageView getItemImageView(Context context, @DrawableRes int resId, YunKeLocalImageSize localImageSize, ImageView.ScaleType scaleType) {
