...
public class EasyPermissions {
    ...
    private static AlertYunkeDialog alertYunkeDialog;
...
//        }
    ...
    private static void showRationaleAlertDialog(
        ...
        if (alertYunkeDialog == null) {
            alertYunkeDialog = new AlertYunkeDialog(activity);
            alertYunkeDialog.setCancelable(false);
            alertYunkeDialog.builder()
                    .setTitle("申请权限")
                    .setMsg(rationale)
